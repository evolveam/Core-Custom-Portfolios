...
// Compute the 6 view start dates: short/long are fixed methodological anchors;
// ytd/1y/3y/5y are rolling windows re-derived every day from the latest available date.
